    ...
    class FacturaTest
    {
      ...
      */
        ...
        public void PuedoGenerarFacturaCorrecta()
        {
            ...
            CarritoCompra carrito = new CarritoCompra(codigo: 1, cedulaCliente: "1002353645");
            ProductoVenta productoVenta = new ProductoVenta(codigoProducto: 0, cantidadVenta: 2);
            carrito.AgregarAlCarrito(productoVenta);
            ...
            Assert.AreEqual(20000, factura.TotalPagar);
            Assert.AreEqual("El nuevo estado del pedido es CONFIRMADO", respuesta);
            Assert.AreEqual("La cantidad de detalles de la factura es 1", "La cantidad de detalles de la factura es " + factura.Detalles.Count());
            #endregion
