...
namespace OrganicSoft.Test.PruebasdeAplicacion
{
    class FacturaTestAplicacion
    {
       ...
       private OrganicSoftContext _context;
        ...
        //    //Act
        //    var response = _facturaService.Handle(new GenerarFacturaCommand(id: 1, codigo: 1, cedulaCliente: "1202", new CrearPedidoCommand(20,10045, new CrearCarritoCommand(30, 20045, "14352"))));
        //    //Assert
