...
internal class CarritoCompra
{
    ...
    internal object DisminuirCantidadProducto(int codigoProductoVenta, int cantidad)
    {
        ...
        {
            if (codigoProductoVenta.Equals(productoVenta.CodigoProducto) && productoVenta.CantidadVenta > cantidad)
            {
                ...
                foreach (var producto in Producto.Productos)
                {
                    if (codigoProductoVenta.Equals(producto.CodigoProducto))
                    {
                        ...
                        respuesta = $"La nueva cantidad del producto {producto.Nombre} en el carrito es {productoVenta.CantidadVenta}";
                    }
                }
            }
        }
